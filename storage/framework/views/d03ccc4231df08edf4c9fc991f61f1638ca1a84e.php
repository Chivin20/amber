            ...
            <div class="row">
                ...
                <div class="col-sm-12 col-md-7">
                    <div style="padding-left: 40px; padding-right: 20px; font-size: 16px; text-align:justify;">
                        ...
                        <h5 style="font-family: 'Quicksand', sans-serif; font-size:20px;">
                        Free Medical Outreach: A program where people received free medical consultation, 
                        free blood pressure test, free blood group test, free malaria parasite test and much more.</h5>
            ...
            <div class="row">
                <div class="col-sm-12 col-md-3"  >
                    ...
                    <div class="card">
                            ...
                            <img style="height:200px" class="rounded img-fluid mx-auto image" src="../assets/img/e1.jpg" />
                            <div class="middle">
                ...
                <div class="col-sm-12 col-md-3"  >
                    ...
                    <div class="card">
                            ...
                            <img style="height:200px" class="rounded img-fluid mx-auto image" src="../assets/img/e2.jpg" />
                            <div class="middle">
                                <div class="text rounded">
                                FREE MEDICAL OUTREACH
                                </div>
                ...
                <div class="col-sm-12 col-md-3"  >
                    ...
                    <div class="card">
                            ...
                            <img style="height:200px" class="rounded img-fluid mx-auto image" src="../assets/img/e3.jpg" />
                            <div class="middle">
                                <div class="text rounded">
                                FREE MEDICAL OUTREACH
                                </div>
                ...
                <div class="col-sm-12 col-md-3"  >
                    ...
                    <div class="card">
                            ...
                            <img style="height:200px" class="rounded img-fluid mx-auto image" src="../assets/img/e4.jpg" />
                            <div class="middle">
                                <div class="text rounded">
                                FREE MEDICAL OUTREACH
                                </div>
                ...
                <div class="col-sm-12 col-md-3"  >
                    ...
                    <div class="card">
                            ...
                            <img style="height:200px" class="rounded img-fluid mx-auto image" src="../assets/img/e5.jpg" />
                            <div class="middle">
                                <div class="text rounded">
                                FREE MEDICAL OUTREACH
                                </div>
                ...
                <div class="col-sm-12 col-md-3"  >
                    ...
                    <div class="card">
                            ...
                            <img style="height:200px" class="rounded img-fluid mx-auto image" src="../assets/img/e6.jpg" />
                            <div class="middle">
                                <div class="text rounded">
                                FREE MEDICAL OUTREACH
                                </div>
                ...
                <div class="col-sm-12 col-md-3"  >
                    ...
                    <div class="card">
                            ...
                            <img style="height:200px" class="rounded img-fluid mx-auto image" src="../assets/img/e7.jpg" />
                            <div class="middle">
                                <div class="text rounded">
                                FREE MEDICAL OUTREACH
                                </div>
