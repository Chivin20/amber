...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
    <div class="container-fluid">
      <a class="navbar-brand" href="/"><img src="{{url('/assets/img/logo1.jpg')}}" height="80px" width="80px" alt="logo"></a>
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent2">
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
          <li class="nav-item">
            <a class="nav-link" id = "navi" aria-current="page" href="{{ route('home') }}">Home</a>
          </li>
         
          <li class="nav-item">
            <a class="nav-link" id = "navi" href="{{route('aboutus')}}" routerLink="/aboutus" routerLinkActive="active">About Us</a>
          </li>

          <li class="nav-item">
            <a class="nav-link" id = "navi" href="{{route('ourevent')}}" routerLink="/ourevent" routerLinkActive="active">Our Event</a>
          </li>

          <li class="nav-item">
            <a class="nav-link" id = "navi" href="{{route('ourteam')}}" routerLink="/ourteam" routerLinkActive="active">Our Team</a>
          </li>
          
          <li class="nav-item">
            <a class="nav-link" id = "navi" href="{{route('contactus')}}" routerLink="/Contactus" routerLinkActive="active">Contact Us</a>
          </li>
      ...
      <div class="row">
        ...
        <div class="col-md-6 mt-md-0 mt-3">
          ...
          <div class="wrapingimage">   
            <img src="{{url('/assets/img/logo.jpg')}}" height="80px" width="80px" alt="logo" style = "padding-right:10px;">    
            </div>   
