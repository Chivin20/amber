                ...
                <div class="col-sm-12 col-md-5" style ="border-right: 5px solid; border-right-color:#FFE5B4;">
                    ...
                    <img class="rounded img-fluid mx-auto image" src="../assets/img/founder1.jpg" width="300px" />
                        <div class="middle">
                            ...
                            <b>Chief. Dr Ndukwo Bassey Kalu and his wife Amber Lea Kalu</b>
                                <br><b>Founder</b>
                            </div>
...
<div class="card" id = "arrange">
        ...
        <img class="rounded img-fluid mx-auto image" style="height:195px ; width:200px;" src="../assets/img/treasure.jpg" />
        <div class="middle">
            <div class="text rounded">
    ...
    <div class="card-body text-center">
        <h5 class="card-title"> <b> Miss Treasure </b> </h5>
      </div>
</div>
</div>
...
<div class="card" id = "arrange">
    ...
    <div class="card-body text-center">
        <h5 class="card-title"> <b> Miss Sarah Ndukwo </b> </h5>
      </div>
</div>
</div>
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\user\Documents\websites\amber\resources\views\ourteam.blade.php ENDPATH**/ ?>