        ...
        <div class="text-left" style="padding-right: 20px; padding-bottom: 25px;">
                ...
                <div class="shadow p-3 mb-2 bg-body rounded">
                    <div class="row">
                        ...
                        <div class="col-9">
                            <h5 style = "text-align:justify;">07012345678 </h5>
                            <h5 style = "text-align:justify;">08112345678</h5>
                        </div>
                    </div>
                </div>
                ...
                <div class="shadow p-3 mb-2 bg-body rounded">
                    <div class="row">
                        ...
                        <div class="col-9">
                            <h5 style = "text-align:justify;">amberfoundation@gmail.com </h5>
                ...
                <div class="shadow p-3 mb-2 bg-body rounded">
                    <div class="row">
                        ...
                        <div class="col-9">
                            <h5 style = "text-align:justify;"> www.amberfoundation.com</h5>
                            <p>&nbsp;</p>
                        </div>
                    </div>
                </div>  
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\user\Documents\websites\amber\resources\views\contactus.blade.php ENDPATH**/ ?>